          ...
          <div class="form-row">
            <div class="col-lg-6 mb-3">
              ...
              <div class="input-group">
                ...
                <input id="local" v-on:focus="autocompleteShow()" v-on:keyup="autocompleteSearch()" type="text" class="form-control" placeholder="Local do equipamento" autocomplete="local" aria-describedby="localPrepend" v-model = "newEquipment.Local" required>
